...
greeting_responses = ['Hello! How can I help you?',
                      ...
                      'Hi, you can ask me anything regarding NgocTinh.',
                      'Hey! wanna know about NgocTinh? Just ask away!']
...
question_answers = {'what are you': 'I am bot, ro-bot :3',
                    ...
                    'what can you do': 'Answer questions regarding NgocTinh!',
                    'what do you do': 'Answer questions regarding NgocTinh!'}

# fetching raw html data about NgocTinh from wiki
...
article = bs.BeautifulSoup(raw_data, 'html.parser')
...
def generate_response(user):
    ...
    word_vectorizer = TfidfVectorizer(
        tokenizer=processed_data, stop_words='english')
    ...
    if vector_matched == 0:
        bracrobo_response = bracrobo_response + 'Sorry, my database doesn\'t have the response for that. Try ' \
                                                'something different and related to NgocTinh. '
...
continue_chat = True
print('Hi! I am NgocTinh Robo. You can ask me anything regarding NgocTinh and I shall try my best to answer IOT technology: ')
while continue_chat:
    ...
    if user_input != 'bye':
        if user_input == 'thanks' or user_input == 'thank you very much' or user_input == 'thank you':
            continue_chat = False
            print('NgocTinh-Robo: Not a problem! (And WELCOME! :D)')
            ...
            if generate_greeting_response(user_input) != None:
                print('NgocTinh-Robo: ' + generate_greeting_response(user_input))
            elif generate_convo_response(user_input) != None:
                print('NgocTinh-Robo: ' + generate_convo_response(user_input))
            elif generate_answers(user_input) != None:
                print('NgocTinh-Robo: ' + generate_answers(user_input))
            else:
                print('NgocTinh-Robo: ', end='')
                print(generate_response(user_input))
                sentences.remove(user_input)
    else:
        continue_chat = False
        print('NgocTinh-Robo: Bye, take care, stay home and stay safe!')
